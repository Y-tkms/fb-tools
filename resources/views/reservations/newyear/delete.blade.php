        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <a href="{{route('rsv.newyear.edit', ['id' => $reservation->id, 'type' => $type])}}" class="btn btn-outline-secondary w-100">Cancel</a>
                </div>
                <div class="col-md-6 mb-3">
                    <form action="{{route('rsv.newyear.deactivate', ['id' => $reservation->id, 'type' => $type])}}" method="POST">
                        @csrf
                        @method('PATCH')
