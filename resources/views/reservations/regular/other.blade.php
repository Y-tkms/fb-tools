    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    <div class="row mt-4">
                        <div class="col-md-6 mb-3"><h3>- Other Date -</h3></div>
                                        ...
                                        @foreach($reservations as $reservation)
                                            <tr>
                                                ...
                                                @if(Auth::user()->role == 'a' || Auth::user()->role == 'er' || Auth::user()->role == 'emr')
                                                    <td><a href="{{route('rsv.regular.edit', ['id' => $reservation->id, 'type' => 'other'])}}">{{$reservation->guest_name}}</a></td>
                                                @else
