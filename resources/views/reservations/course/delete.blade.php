        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <a href="{{route('rsv.course.edit', $reservation->id)}}" class="btn btn-outline-secondary w-100">Cancel</a>
                </div>
                <div class="col-md-6 mb-3">
                    <form action="{{route('rsv.course.deactivate', $reservation->id)}}" method="POST">
                        @csrf
                        @method('PATCH')
